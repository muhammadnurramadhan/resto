...
<body class="body">
    <div style="display: flex; justify-content:center; align-items:center; flex-direction:column">
        ...
        <form role="form text-left" method="POST" action="/reservasi-nama-session">
            @csrf
            <div class="form-group" style="margin-top: 10%;">
                <input type="name" name="name" class="form-control" id="name" aria-describedby="name" placeholder="Nama">
            </div>
