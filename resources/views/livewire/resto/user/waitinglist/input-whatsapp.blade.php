...
<body class="body">
    <div style="display: flex; justify-content:center; align-items:center; flex-direction:column">
        ...
        <h1 style="color: #264c3d;font-size:2rem; padding-left: 10%; padding-right: 10%; text-align:center">hubungi kamu, isi
            nomor whatsapp
            kamu di sini ya..
        </h1>

        <form role="form text-left" method="POST" action="/waitinglist-whatsapp-session">
            @csrf
        ...
        {{-- <button style="width: 50%; margin: 6%" type="button" class="btn btn-dark" onclick="location.href='{{ url('waitinglist-jumlah-orang') }}'">Lanjut</button> --}}
    </div>
