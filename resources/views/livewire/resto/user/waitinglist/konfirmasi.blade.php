...
<body class="body">
    <div style="display: flex; justify-content:center; align-items:center; flex-direction:column">
        <h1
            style="color: #264c3d;font-size:1.8rem; padding-left: 10%; padding-right:10%; text-align:center; align-items:center; justify-content:center; margin-top: 35%">
            Konfirmasi waiting list
            kamu dulu ya,
        </h1>
        <!-- <h1 style="color: #264c3d;font-size:2rem;">siapa ?</h1> -->

        <div style="display: flex; justify-content: center; align-items:center; width: 25rem; margin-top: 10%">
        ...
        <form role="form text-left" method="POST" action="/waitinglist-konfirmasi-session"
            style="width: 100%; display:flex; justify-content:center; align-items:center; flex-direction:column; margin-bottom: 5%">
            @csrf
            <div class="form-check form-check-info text-left"
                style="display: flex; justify-content:center; align-items:center; text-align:center; width:70%; margin-top: 10%">
            ...
            <button style="width: 50%; margin: 2%" type="submit" class="btn btn-dark" onclick="location.href='{{ url('waitinglist-konfirmasi') }}'">Lanjut</button>
        </form>
    </div>
