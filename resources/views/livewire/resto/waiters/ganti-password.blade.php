...
<body class="body">
    <div style="display: flex; width: 100%; flex-direction: column">
        ...
        <div style="display: flex; margin-top:1%; justify-content:center; align-items:center; flex-direction:column; margin-top: 15%">
            <div style="display: flex; margin: 2%; justify-content:center; align-items:center; ">

                <form method="POST" action="waiters-password-session">

                    @csrf
                    
                    <div class="form-group" style="margin: 5%;">
                        <label for="exampleInputEmail1" style="margin-bottom: 5%">Password Lama</label>
                        <input disabled type="password" class="form-control" id="password" aria-describedby="password"
                            placeholder={{$user->password}}>
                        <small id="password" class="form-text text-light">old password.</small>
                        @error('password')
                    ...
                    <div class="form-group" style="margin: 5%;">
                        <label for="exampleInputEmail1" style="margin-bottom: 5%">Password baru</label>
                        <input name="password" type="password" class="form-control" id="password" aria-describedby="password"
                            placeholder="Ubah password">
                        <small id="password" class="form-text text-light">new password.</small>
                        @error('password')
                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div style="display: flex; justify-content:center; align-items:center; margin-top: 10%">
                        <button
                            ...
                            type="submit" class="btn btn-dark">Konfirm</button>
                    </div>
