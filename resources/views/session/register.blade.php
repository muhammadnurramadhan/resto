    ...
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('../assets/img/curved-images/curved14.jpg');">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto" style="height: 100px; display: flex">
          </div>
        </div>
      </div>
    </div>
              ...
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Setuju <a href="javascript:;" class="text-dark font-weight-bolder">Syarat dan ketentuan</a>
                  </label>
                  @error('agreement')
