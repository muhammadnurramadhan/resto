...
class InfoUserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->role == 2) {
            ...
            $updateUser = $request->validate([
                ...
                'jumlah_dp' => 'max:255',
                'meja' => 'max:255',
                'jumlah_kedatangan' => 'max:255',
                'pilih_jenis_reservasi' => 'max:255',
                'pilih_cabang' => 'max:255',
            ]);
        }
    ...
    public function show_antrian(User $user)
    {
        ...
        return view('tables_antrian', ['cabang' => $cabang, 'antrian_reservasi' => $antrian_reservasi, 'antrian_dinein' => $antrian_dinein, 'antrian_takeaway' => $antrian_takeaway,]);
    }
}
